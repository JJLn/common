...
+ (void)showWithText:(NSString *)text_{
    [JJToast showWithText:text_ duration:DEFAULT_DISPLAY_DURATION];
}

+ (void)showWithText:(NSString *)text_
            duration:(CGFloat)duration_{
    JJToast *toast = [[JJToast alloc] initWithText:text_];
...
+ (void)showWithText:(NSString *)text_
    ...
    [JJToast showWithText:text_  topOffset:topOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
...
+ (void)showWithText:(NSString *)text_
    ...
    [JJToast showWithText:text_  bottomOffset:bottomOffset_ duration:DEFAULT_DISPLAY_DURATION];
}
